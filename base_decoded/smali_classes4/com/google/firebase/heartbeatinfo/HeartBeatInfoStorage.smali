...
.method private declared-synchronized getFormattedDate(J)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/common/math/Stats$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Date;)Ljava/time/Instant;

    move-result-object p1

    .line 140
    invoke-static {}, Lcom/google/common/math/Stats$$ExternalSyntheticApiModelOutline0;->m()Ljava/time/ZoneOffset;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/google/common/math/Stats$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/Instant;Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;

    move-result-object p1

    invoke-static {p1}, Lcom/google/common/math/Stats$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/OffsetDateTime;)Ljava/time/LocalDateTime;

    move-result-object p1

    .line 141
    invoke-static {}, Lcom/google/common/math/Stats$$ExternalSyntheticApiModelOutline0;->m()Ljava/time/format/DateTimeFormatter;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/google/common/math/Stats$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/LocalDateTime;Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;
