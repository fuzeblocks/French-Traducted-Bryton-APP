...
.method constructor <init>(Lorg/reactivestreams/Subscriber;ILj$/util/stream/Collector;)V
    ...
    .line 80
    invoke-interface {p3}, Lj$/util/stream/Collector;->finisher()Ljava/util/function/Function;
    ...
    invoke-interface {p3}, Lj$/util/stream/Collector;->supplier()Ljava/util/function/Supplier;
    ...
    invoke-interface {p3}, Lj$/util/stream/Collector;->accumulator()Ljava/util/function/BiConsumer;

    move-result-object v3

    invoke-interface {p3}, Lj$/util/stream/Collector;->combiner()Ljava/util/function/BinaryOperator;
