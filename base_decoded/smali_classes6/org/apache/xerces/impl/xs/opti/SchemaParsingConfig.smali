...
.field protected fSchemaDOMParser:Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;
...
.method public constructor <init>(Lorg/apache/xerces/util/SymbolTable;Lorg/apache/xerces/xni/grammars/XMLGrammarPool;Lorg/apache/xerces/xni/parser/XMLComponentManager;)V
    ...
    const-string v6, "http://apache.org/xml/features/scanner/notify-char-refs"
    ...
    invoke-virtual {p0, p3}, Lorg/apache/xerces/util/ParserConfigurationSettings;->addRecognizedFeatures([Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p3, v0}, Lorg/apache/xerces/parsers/BasicParserConfiguration;->setFeature(Ljava/lang/String;Z)V
    ...
    const-string v7, "http://apache.org/xml/properties/internal/datatype-validator-factory"

    const-string v8, "http://apache.org/xml/properties/internal/validation-manager"
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createEntityManager()Lorg/apache/xerces/impl/XMLEntityManager;
    ...
    iget-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fEntityManager:Lorg/apache/xerces/impl/XMLEntityManager;
    ...
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createErrorReporter()Lorg/apache/xerces/impl/XMLErrorReporter;

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fErrorReporter:Lorg/apache/xerces/impl/XMLErrorReporter;

    iget-object p2, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fEntityManager:Lorg/apache/xerces/impl/XMLEntityManager;
    ...
    iget-object p2, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fErrorReporter:Lorg/apache/xerces/impl/XMLErrorReporter;

    invoke-virtual {p0, p1, p2}, Lorg/apache/xerces/parsers/BasicParserConfiguration;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V

    iget-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fErrorReporter:Lorg/apache/xerces/impl/XMLErrorReporter;

    invoke-virtual {p0, p1}, Lorg/apache/xerces/parsers/BasicParserConfiguration;->addComponent(Lorg/apache/xerces/xni/parser/XMLComponent;)V

    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createDocumentScanner()Lorg/apache/xerces/xni/parser/XMLDocumentScanner;

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fScanner:Lorg/apache/xerces/xni/parser/XMLDocumentScanner;

    const-string p2, "http://apache.org/xml/properties/internal/document-scanner"

    invoke-virtual {p0, p2, p1}, Lorg/apache/xerces/parsers/BasicParserConfiguration;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V

    iget-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fScanner:Lorg/apache/xerces/xni/parser/XMLDocumentScanner;
    ...
    :cond_1
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createDTDScanner()Lorg/apache/xerces/xni/parser/XMLDTDScanner;

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fDTDScanner:Lorg/apache/xerces/xni/parser/XMLDTDScanner;
    ...
    iget-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fDTDScanner:Lorg/apache/xerces/xni/parser/XMLDTDScanner;
    ...
    :cond_2
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createNamespaceBinder()Lorg/apache/xerces/impl/XMLNamespaceBinder;

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fNamespaceBinder:Lorg/apache/xerces/impl/XMLNamespaceBinder;
    ...
    iget-object p1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fNamespaceBinder:Lorg/apache/xerces/impl/XMLNamespaceBinder;

    invoke-virtual {p0, p1}, Lorg/apache/xerces/parsers/BasicParserConfiguration;->addComponent(Lorg/apache/xerces/xni/parser/XMLComponent;)V

    :cond_3
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createDatatypeValidatorFactory()Lorg/apache/xerces/impl/dv/DTDDVFactory;
    ...
    :cond_4
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createValidationManager()Lorg/apache/xerces/impl/validation/ValidationManager;
    ...
    iget-object p3, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fErrorReporter:Lorg/apache/xerces/impl/XMLErrorReporter;
...
.method protected configurePipeline()V
    ...
    iget-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fScanner:Lorg/apache/xerces/xni/parser/XMLDocumentScanner;

    iget-object v1, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fNamespaceBinder:Lorg/apache/xerces/impl/XMLNamespaceBinder;
    ...
    iget-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fNamespaceBinder:Lorg/apache/xerces/impl/XMLNamespaceBinder;
    ...
    iget-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fDTDScanner:Lorg/apache/xerces/xni/parser/XMLDTDScanner;
...
.method protected createSchemaDOMParser()Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;
    .locals 1

    new-instance v0, Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;

    invoke-direct {v0, p0}, Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;-><init>(Lorg/apache/xerces/xni/parser/XMLParserConfiguration;)V
...
.method public getDocument()Lorg/w3c/dom/Document;
    ...
    iget-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fSchemaDOMParser:Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;

    invoke-virtual {v0}, Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;->getDocument()Lorg/w3c/dom/Document;
...
.method public reset()V
    ...
    invoke-virtual {p0}, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->createSchemaDOMParser()Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;

    move-result-object v0

    iput-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fSchemaDOMParser:Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;

    iput-object v0, p0, Lorg/apache/xerces/parsers/BasicParserConfiguration;->fDocumentHandler:Lorg/apache/xerces/xni/XMLDocumentHandler;

    iget-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fSchemaDOMParser:Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;

    iput-object v0, p0, Lorg/apache/xerces/parsers/BasicParserConfiguration;->fDTDHandler:Lorg/apache/xerces/xni/XMLDTDHandler;

    iget-object v0, p0, Lorg/apache/xerces/impl/xs/opti/SchemaParsingConfig;->fSchemaDOMParser:Lorg/apache/xerces/impl/xs/opti/SchemaDOMParser;

    iput-object v0, p0, Lorg/apache/xerces/parsers/BasicParserConfiguration;->fDTDContentModelHandler:Lorg/apache/xerces/xni/XMLDTDContentModelHandler;
