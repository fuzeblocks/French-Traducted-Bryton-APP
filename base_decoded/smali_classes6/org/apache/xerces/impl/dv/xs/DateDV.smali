...
.method protected dateToString([I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v3, v4}, Lorg/apache/xerces/impl/dv/xs/AbstractDateTimeDV;->append(Ljava/lang/StringBuffer;II)V

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(C)Ljava/lang/StringBuffer;

    aget v2, p1, v4

    invoke-virtual {p0, v0, v2, v4}, Lorg/apache/xerces/impl/dv/xs/AbstractDateTimeDV;->append(Ljava/lang/StringBuffer;II)V
...
.method public getActualValue(Ljava/lang/String;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-virtual {p0, p1}, Lorg/apache/xerces/impl/dv/xs/DateDV;->parse(Ljava/lang/String;)[I

    move-result-object v1

    invoke-direct {v0, v1, p0}, Lorg/apache/xerces/impl/dv/xs/AbstractDateTimeDV$DateTimeData;-><init>([ILorg/apache/xerces/impl/dv/xs/AbstractDateTimeDV;)V
    :try_end_0
...
.method protected parse(Ljava/lang/String;)[I
    ...
    invoke-virtual {p0, p1, v0, v3, v6}, Lorg/apache/xerces/impl/dv/xs/AbstractDateTimeDV;->getDate(Ljava/lang/String;II[I)I
