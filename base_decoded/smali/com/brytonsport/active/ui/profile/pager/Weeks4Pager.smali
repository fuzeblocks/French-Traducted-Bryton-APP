.class public Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;
.super Lcom/brytonsport/active/ui/profile/pager/Vo2MaxPage;
.source "Weeks4Pager.java"


# instance fields
.field private binding:Lcom/brytonsport/active/databinding/PagerWeeks4Binding;
...
.field private week4List:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->timeEntryList:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->drawOrders:[Lcom/github/mikephil/charting/charts/CombinedChart$DrawOrder;
    ...
    invoke-static {v0}, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->inflate(Landroid/view/LayoutInflater;)Lcom/brytonsport/active/databinding/PagerWeeks4Binding;

    move-result-object v0

    iput-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->binding:Lcom/brytonsport/active/databinding/PagerWeeks4Binding;

    .line 44
    iget-object v0, v0, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->chartLayout:Landroid/widget/RelativeLayout;
    ...
    iput-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->chart:Lcom/github/mikephil/charting/charts/CombinedChart;

    .line 46
    iget-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->binding:Lcom/brytonsport/active/databinding/PagerWeeks4Binding;

    iget-object v0, v0, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->chartLayout:Landroid/widget/RelativeLayout;

    iget-object v1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->chart:Lcom/github/mikephil/charting/charts/CombinedChart;
    ...
    .line 47
    invoke-direct {p0}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->setText()V

    .line 48
    iget-object p1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->binding:Lcom/brytonsport/active/databinding/PagerWeeks4Binding;

    invoke-virtual {p1}, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->getRoot()Landroid/widget/RelativeLayout;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->addView(Landroid/view/View;)V
...
.method private drawTimeLine(JJ)V
    ...
    .line 79
    iget-object v2, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->timeEntryList:Ljava/util/List;

    invoke-interface {v2}, Ljava/util/List;->clear()V

    .line 80
    iget-object v2, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->week4List:Ljava/util/ArrayList;
    ...
    .line 84
    :cond_1
    iget-object v5, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->timeEntryList:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->timeEntryList:Ljava/util/List;
    ...
    .line 90
    invoke-virtual {p0}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->getResources()Landroid/content/res/Resources;
    ...
    .line 101
    iget-object p3, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->chart:Lcom/github/mikephil/charting/charts/CombinedChart;

    invoke-virtual {p0, p1, p2, p3}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->setDefaultChartStyle(JLcom/github/mikephil/charting/charts/CombinedChart;)V
    ...
    .line 116
    new-instance p4, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager$1;

    invoke-direct {p4, p0, p1, p2}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager$1;-><init>(Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;J)V
    ...
    .line 125
    iget-object p1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->chart:Lcom/github/mikephil/charting/charts/CombinedChart;
...
.method private setText()V
    ...
    iput-wide v1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->startSec:J
    ...
    iput-wide v1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->endSec:J

    .line 59
    iget-object v1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->binding:Lcom/brytonsport/active/databinding/PagerWeeks4Binding;

    iget-object v1, v1, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->txtDate:Landroid/widget/TextView;
    ...
    iget-object v0, v0, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->txtNoDataMessage:Landroid/widget/TextView;
...
.method protected setDefaultChartStyle(JLcom/github/mikephil/charting/charts/CombinedChart;)V
    ...
    .line 144
    iget-object v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->drawOrders:[Lcom/github/mikephil/charting/charts/CombinedChart$DrawOrder;
    ...
    invoke-virtual {p0}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->getContext()Landroid/content/Context;
    ...
    .line 170
    new-instance v0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager$2;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager$2;-><init>(Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;JLjava/text/DecimalFormat;Lcom/brytonsport/active/ui/profile/view/ValueMarker;)V
...
.method public setList(Ljava/util/ArrayList;)V
    ...
    .line 69
    :cond_0
    iget-object v2, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->binding:Lcom/brytonsport/active/databinding/PagerWeeks4Binding;

    iget-object v2, v2, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->noDataView:Landroid/widget/RelativeLayout;
    ...
    .line 71
    iput-object p1, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->week4List:Ljava/util/ArrayList;

    .line 72
    iget-wide v0, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->startSec:J

    iget-wide v2, p0, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->endSec:J

    invoke-direct {p0, v0, v1, v2, v3}, Lcom/brytonsport/active/ui/profile/pager/Weeks4Pager;->drawTimeLine(JJ)V
    ...
    iget-object p1, p1, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->noDataView:Landroid/widget/RelativeLayout;
    ...
    iget-object p1, p1, Lcom/brytonsport/active/databinding/PagerWeeks4Binding;->chartLayout:Landroid/widget/RelativeLayout;
