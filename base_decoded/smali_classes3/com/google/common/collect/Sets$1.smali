...
.method public parallelStream()Ljava/util/stream/Stream;
    ...
    invoke-static {v0}, Lcom/google/common/base/Optional$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;)Ljava/util/stream/BaseStream;
...
.method public stream()Ljava/util/stream/Stream;
    ...
    invoke-static {v0}, Lcom/google/common/base/Optional$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Set;)Ljava/util/stream/Stream;

    move-result-object v0

    iget-object v1, p0, Lcom/google/common/collect/Sets$1;->val$set2:Ljava/util/Set;

    invoke-static {v1}, Lcom/google/common/base/Optional$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Set;)Ljava/util/stream/Stream;

    move-result-object v1

    iget-object v2, p0, Lcom/google/common/collect/Sets$1;->val$set1:Ljava/util/Set;

    new-instance v3, Lcom/google/common/collect/Sets$1$$ExternalSyntheticLambda4;

    invoke-direct {v3, v2}, Lcom/google/common/collect/Sets$1$$ExternalSyntheticLambda4;-><init>(Ljava/util/Set;)V

    invoke-static {v1, v3}, Lcom/google/common/base/Optional$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v1

    invoke-static {v0, v1}, Lcom/google/common/base/Optional$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;Ljava/util/stream/Stream;)Ljava/util/stream/Stream;
